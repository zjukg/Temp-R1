...
def _select_rm_score_fn(data_source):
    if data_source in ['metaqa','timequestions','multitq','timelinekgqa','nq', 'triviaqa', 'popqa', 'web_questions', 'hotpotqa', '2wikimultihopqa', 'musique', 'bamboogle', 'strategyqa']:
...
class RewardManager():
    ...
    def __call__(self, data: DataProto):
        ...
        for i in range(len(data)):
            ...
            #qtype = data_item.non_tensor_batch['extra_info']['qtype']
            # select rm_score
...
def main(config):
    if not ray.is_initialized():
        ...
        ray.init(
            ...
            _system_config={"worker_niceness": 0}  # Set worker nice value to 0 for normal priority
        )
