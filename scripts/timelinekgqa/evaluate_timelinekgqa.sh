...
#export DATA_DIR='data/timelinekgqa_cron_search'
export DATA_DIR='data/timelinekgqa_icews_actor_search'
...
# ============ 实验配置 ============
WAND_PROJECT='timelinekgqa-eval'
export BASE_MODEL='verl_checkpoints/timelinekgqa-grpo-llama3.1-8b-it-sft-75-complex/actor/global_step_70'
export EXPERIMENT_NAME=timelinekgqa-eval
...
PYTHONUNBUFFERED=1 nice -n 0 python3 -m verl.trainer.main_ppo_format \
    ...
    max_turns=3 \
    retriever.url="http://127.0.0.1:8080/retrieve" \
    retriever.topk=30 \
