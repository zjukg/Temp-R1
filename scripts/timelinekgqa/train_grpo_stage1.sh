...
# ============ 实验配置 ============
WAND_PROJECT='timelinekgqa-llama3.1-8B-it-sft'
export BASE_MODEL='/LLaMA-Factory/saves/xxx'
export EXPERIMENT_NAME=timelinekgqa-grpo
...
PYTHONUNBUFFERED=1 nice -n 0 python3 -m verl.trainer.main_ppo_format \
    data.train_files=$DATA_DIR/train_complex.parquet \
    data.val_files=$DATA_DIR/test_complex.parquet \
